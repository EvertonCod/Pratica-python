#EXERCICIO CONCLUIDO
# A ACME Inc., uma empresa de 500 funcionários, está
...
# qual o espaço ocupado pelos usuários, e identificar os usuários com maior espaço ocupado. Através de um programa,
...
# caso sejam necessários, de forma a agilizar a execução do programa. A conversão da espaço ocupado em 
# disco, de bytes para megabytes deverá ser feita através de uma função separada, que será chamada pelo
...
somatorio = 0
for i in usuario_armazenam_.values():
    somatorio+=i

cont = 1;
for nome, bytes_ in usuario_armazenam_.items():
    conta = (bytes_/somatorio)*100;
    conversao = bytes_/1024/1024;
    print(f'# {cont} {nome}  {conversao:.2f} MB  - {conta:.2f} %');
    cont+=1